...
Papers with publicly released code or project resources include a `Source` link. Entries without verified repositories use `-` in that column.
...
| [ICLR](https://openreview.net/forum?id=QOWYX3Q2XS) | MENLO: From Preferences to Proficiency – Evaluating and Modeling Native-like Quality Across 47 Languages | [Code](https://huggingface.co/datasets/facebook/menlo) |
